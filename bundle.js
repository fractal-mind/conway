...
/***/ function(module, exports, __webpack_require__) {
	  ...
	  _createClass(Grid, [{
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        'table',
	        null,
	        _react2.default.createElement(CellMap, null)
	      );
	    }
	  }]);
	...
	var CellMap = function (_React$Component8) {
	  ...
	  function CellMap() {
	    ...
	    return _possibleConstructorReturn(this, Object.getPrototypeOf(CellMap).apply(this, arguments));
	  }
	...
	var CellRow = function (_React$Component9) {
	  ...
	  function CellRow() {
	    ...
	    return _possibleConstructorReturn(this, Object.getPrototypeOf(CellRow).apply(this, arguments));
	  }

	  _createClass(CellRow, [{
	    key: 'render',
	    value: function render() {
	      return _react2.default.createElement(
	        'tr',
	        ...
	        this.props.cells.map(function (cell) {
	          return _react2.default.createElement(Cell, { alive: cell.alive, key: cell.key, index: cell.key });
	        })
	      );
	    }
	  }]);
